...
function updateCart(order) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', order).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    updateCart(order); //console.log(order)
  });
});
...
__webpack_require__(/*! C:\Users\navdi\Desktop\OrderService\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\navdi\Desktop\OrderService\resources\scss\app.scss */"./resources/scss/app.scss");
